...
@section('content')
  ...
  <div class="ui grid">
   	<div class="sixteen wide mobile sixteen wide tablet eight wide computer column">
  		<div id="chartRevenueBulananRI"></div>
    	@linechart('revenueBulananRI','chartRevenueBulananRI')
  	</div>
  	<div class="sixteen wide mobile sixteen wide tablet eight wide computer column">
  		<div id="chartJumlahPasienBulananRI"></div>
    	@linechart('jumlahPasienBulananRI','chartJumlahPasienBulananRI')
  	</div>
  </div>
